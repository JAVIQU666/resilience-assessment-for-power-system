function [result] = calLshapednormal365withmaingridexwind(resultnor,time, totalRela, mpc0, mpcre0, mpcrelcoe0, equipment, mpc_model_load20, Pload, WT, PV, rateload, scen,ProvDisaster,pdc,powerinter,firpower)
