function [result] = calLshapeddisaster8760(totalRela, A,T0,h0,c,eq,ineq,mpc0, mpcre0, mpcrelcoe0, equipment, mpc_model_load20, Pload, WT, PV, rateload, scen,powerinter,firpower)
...
Cpntnum = [BScapcent,NGcap,NGCCScap,COALcap,COALCCScap,Biopowercap,BiopowerCCScap,Geothermalcap,Hydropowercap,Nuclearcap,OFFWTcap,...
...
for stage=1:length(period)
    ...
    for qqq=1:time
        ...
        indextempreliability{stage,qqq} = find(h0==-rateload(stage)*111000);
    end
...
while true
    ...
    MPCpntnum = [MPBScapcent,MPNGcap,MPNGCCScap,MPCOALcap,MPCOALCCScap,MPBiopowercap,MPBiopowerCCScap,MPGeothermalcap,MPHydropowercap,MPNuclearcap,MPOFFWTcap,...
